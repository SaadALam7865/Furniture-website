    ...
    <div>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <h1 className="font-Poppins md:text-[40px] font-[500] lg:text-[48px] text-[#000000]">
            Product Comparison
          </h1>
      ...
      <div className="mx-auto px-4 sm:px-2 py-16">
        <div className="font-poppins flex flex-col gap-6 items-center sm:items-start lg:flex-row lg:justify-around">
          ...
          <div className="gap-3 flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            />
            <h2 className="text-2xl font-semibold leading-[30.36px] pt-3 pb-2">
              Asgaard Sofa
            </h2>
          ...
          <div className="gap-3 flex flex-col items-center sm:items-start text-center sm:text-left">
            <Image
              ...
              className="rounded-lg bg-[#FAF3EA] object-cover hover:scale-110"
            />
            <h2 className="text-2xl font-semibold font-Poppins leading-[30.36px] pt-3 pb-2">
              Outdoor Sofa Set
            </h2>
            <p className="font-medium text-[18px] leading-[30.36px] pb-2">
              Rs. 250,000.00
          ...
          <div className="w-full lg:w-auto flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <select
              id="country"
              className="w-auto px-6 py-2 border hover:cursor-pointer border-gray-400 rounded-md shadow-sm focus:outline-none bg-[#B88E2F] focus:border-primary text-white"
            >
              <option value="potty">Choose a Product</option>
              <option value="">Lolito</option>
              <option value="">Pingky</option>
              <option value="">Muggo</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="border-t-2 border-[#727272] px-4 sm:px-2 pl-10  font-poppins w-full h-auto">
        ...
        <div className="flex flex-wrap lg:flex-nowrap w-full items-start">
          ...
          <div className="flex flex-col border-r-2 border-[#727272] px-4 lg:px-12 mb-6 lg:mb-0 w-full lg:w-1/3 ">
            <h2 className="font-semibold font-Poppins text-[28px] leading-[35.8px] w-[175px] h-[35px]">
              General
            </h2>
        ...
        <div className="flex flex-wrap lg:flex-nowrap w-full items-start mt-10">
          ...
          <div className="flex flex-col border-r-2 border-[#727272] px-4 lg:px-20 mb-6 lg:mb-0 w-full lg:w-1/3">
            ...
            <button className="bg-[#B88E2F] mt-5 text-white font-[400] text-[20px] leading-[30px] px-4 py-2 rounded-sm">
              Add To Cart
            </button>
          </div>
          ...
          <div className="flex flex-col border-r-2 border-[#727272] px-4 lg:px-20 w-full lg:w-1/3">
            ...
            <Link href="/"><button className="bg-[#B88E2F] w-full mt-8 text-white font-[400] text-[20px] leading-[30px] px-4 py-2 rounded-sm">
              Add To Cart
            </button></Link>
          </div>
        </div>
